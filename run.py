...
def home():
    dicti['age'] = request.args['age']
    dicti['sexo'] = request.args['gender']
    dicti['pais_residencia'] = request.args['nationality']
    dicti['antiguedad'] = request.args['seniority']
    dicti['tiprel_1mes'] = request.args['relationship_type']
    dicti['ind_actividad_cliente'] = request.args['activity_level']
    dicti['segmento'] = request.args['segment']
    dicti['renta'] = request.args['annual_income']
    dicti['nomprov'] = request.args['region']
    ...
    # Process the Data
    x_vars_list, y_vars_list, cust_dict = processData(dicti, {})
    ...
    final_preds_array = final_preds[0].split(" ")
    return jsonify(final_preds_array), 200
